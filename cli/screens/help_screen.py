    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(id="help-container"):
            ...
            yield Static(
                ...
                "  Ctrl+O      Import appointments from Excel\n"
                "  Ctrl+P      Open Textual command palette (framework actions/help),\n"
                "              including theme switching and startup welcome toggle\n"
                "  Ctrl+U      Upload imported preview list\n"
